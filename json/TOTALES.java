...
public class TOTALES {
    ...
    public TOTALES(double impuestoTotalExento, double impuestoTotalAl5, double impuestoTotalAl10, double valorTotalExento, double valorTotalAl5, double valorTotalAl10, double impuestoTotal, double valorTotal) {
