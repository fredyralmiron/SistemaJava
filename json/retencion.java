...
public class retencion {
    ...
    public retencion(Date fecha, String moneda, boolean retencionRenta, String conceptoRenta, boolean retencionIva, String conceptoIva, int rentaPorcentaje, int rentaCabezasBase, int rentaCabezasCantidad, int rentaToneladasBase, int rentaToneladasCantidad, String ivaPorcentaje5, String ivaPorcentaje10) {
        this.fecha = fecha;
        this.moneda = moneda;
