...
public class informante {
    ...
    public informante(String nombre, String Dv, String nombreFantasia, String domicilioEmision, String telefono, String ruc, String codigoEstablecimiento, String timbradoFactura, String puntoExpedicionFactura, Date inicioVigenciaFactura, String timbradoComprobante, String puntoExpedicionComprobante, Date inicioVigenciaComprobante, String establecimiento) {
        this.nombre = nombre;
        this.Dv = Dv;
